                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('banners.index')}}" class="nav-link ">
                                        <span class="title">View  Banners</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                <a href="{{route('banners.create')}}" class="nav-link ">
                                        <span class="title">Create Banners</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('languages.index')}}" class="nav-link ">
                                        <span class="title">View  Language</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('massages.index')}}" class="nav-link ">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-docs"></i>
                                <span class="title">Subscripes</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{route('subscripe.index')}}" class="nav-link ">
                                        <span class="title">View  Subscripe</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="{{route('subscripe.create')}}" class="nav-link ">
                                        <span class="title">Create  Subscripe</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
...
@endif
        ...
        <script src="{{url('backend/assets/global/plugins/cookie.min.js')}}" type="text/javascript"></script>

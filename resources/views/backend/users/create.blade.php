                                            ...
                                            @csrf
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" value='{{old("name")}}' class="form-control input-circle" name="name" placeholder="User Name">
                                                        </div>
                                                    </div>
                                                    <!--email-->
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                        <input type="email" value='{{old("email")}}' class="form-control input-circle" name="email"  placeholder="User Email"id="exampleFormControlFile1">
                                                        </div>
                                                    </div>
                                                    <!--password-->
                                                    <div class="form-group">

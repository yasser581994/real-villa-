                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group  ">
                                                            ...
                                                            <div class="input-group col-md-6">
                                                                ...
                                                                <input type="text" class="form-control input-circle-right" value='{{old("text.$one->code")}}'
                                                        ...
                                                        <div class="form-group  ">
                                                            ...
                                                            <div class="input-group col-md-6">
                                                                <input value='{{old("icon")}}' type="text" class="form-control input-circle" name="icon" placeholder="icon">
                                                            </div>
                                                        </div>
                                                    </div> 
